    ...
    parentLoginId = hostelStudent.ParentLoginId,
    parentTemporaryPassword = hostelStudent.ParentTemporaryPassword,
                block = room?.Block,
...
public async Task<IActionResult> GetParentStudent(string parentUserId)
{
    var parent = await _context.Users
        .FirstOrDefaultAsync(x => x.UserId == parentUserId);
    ...
    var hostelStudent = await _context.StudentRegistrations
        .FirstOrDefaultAsync(x => x.StudentId == parent.StudentId);
    ...
    var studentUser = await _context.Users
        .FirstOrDefaultAsync(x => x.UserId == parent.StudentId);
    ...
    return Ok(new
    {
        ...
        profilePhoto = studentUser?.ProfilePhoto,
